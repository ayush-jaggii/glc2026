...
export const PANELISTS_DATA: Panelist[] = [
  ...
  // Closed Group Discussion (CGD) Panel
  {
    ...
    designation: 'Co-Founder, Chairman & MD',
    linkedin: 'https://linkedin.com/in/ckknaturals',
    trackCode: 'CGD',
    trackName: 'Closed Group Discussion',
    photo: '/images/panelists/CGD/CK_Kumaravel_CGD.jpeg',
    tags: ['Franchise Scaling', 'Entrepreneurship', 'Retail Service'],
  },
  {
    id: 'cgd-2',
    name: 'Shehnaz Shariff',
    company: 'Indian Terrain Fashions',
    designation: 'Chief Business Officer (CBO)',
    linkedin: 'https://linkedin.com/in/shehnaz-shariff-09379033',
    trackCode: 'CGD',
    trackName: 'Closed Group Discussion',
    photo: '/images/panelists/CGD/ShehnazShariff_CGD.png',
    tags: ['Apparel Commerce', 'Omnichannel Strategy', 'Brand P&L'],
  },
  {
    id: 'cgd-3',
    name: 'Kuldeep Rayasam',
    company: 'Anand Rathi Wealth Ltd',
    designation: 'Associate Director',
    linkedin: 'https://www.linkedin.com/in/kuldeep-rayasam-6203a615/',
    trackCode: 'CGD',
    trackName: 'Closed Group Discussion',
    photo: '/images/panelists/CGD/Kuldeep_Rayasam_CGD.png',
    tags: ['HNW Portfolios', 'Private Wealth', 'Asset Allocation'],
  },
  {
    id: 'cgd-4',
    name: 'Mohan Chandrasekar',
    company: 'Aptia Group India',
    designation: 'Chief Legal, Risk & Compliance Officer',
    linkedin: 'https://linkedin.com/in/mchandrasekar',
    trackCode: 'CGD',
    trackName: 'Closed Group Discussion',
    photo: '/images/panelists/CGD/Mohan_Chandrasekar_CGD.png',
    tags: ['Cross-Border Law', 'Enterprise Governance', 'Global Compliance'],
  },
  {
    id: 'cgd-5',
...
export const FEATURED_ACCORDION_ITEMS = [
  {
    id: 'cgd-1',
    url: '/images/panelists/CGD/CK_Kumaravel_CGD.jpeg',
    title: 'C K Kumaravel',
    description: 'Naturals · Co-Founder & MD',
    company: 'Naturals Salon & Spa',
    designation: 'Co-Founder, Chairman & MD',
    linkedin: 'https://linkedin.com/in/ckknaturals',
    track: 'Executive Roundtable',
    tags: ['Entrepreneurship', 'Retail Scale', 'Franchise'],
  },
  {
    id: 'it-1',
