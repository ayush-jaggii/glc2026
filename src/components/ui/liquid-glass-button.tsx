...
const buttonVariants = cva(
  "inline-flex items-center cursor-pointer justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-brand-orange text-white hover:bg-brand-orange-dark shadow-md",
        destructive:
          "bg-destructive text-primary-foreground hover:bg-destructive/90",
        cool: "dark:inset-shadow-2xs dark:inset-shadow-white/10 bg-gradient-to-t border border-b-2 border-slate-900/40 from-brand-orange to-brand-orange/85 shadow-md shadow-brand-orange/20 ring-1 ring-inset ring-white/25 transition-[filter] duration-200 hover:brightness-110 active:brightness-90 text-white",
        outline:
...
const liquidbuttonVariants = cva(
  "inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: "bg-brand-orange text-white hover:scale-105 duration-300 transition shadow-lg hover:shadow-brand-orange/30",
        destructive:
      ...
      size: {
        ...
        xxl: "h-16 rounded-full px-12 has-[>svg]:px-10",
        icon: "size-10",
      },
    },
    defaultVariants: {
    ...
    <>
      ...
      >
        <div className="absolute top-0 left-0 z-0 h-full w-full rounded-full 
            shadow-[0_0_6px_rgba(0,0,0,0.03),0_2px_6px_rgba(0,0,0,0.08),inset_3px_3px_0.5px_-3px_rgba(255,255,255,0.4),inset_-3px_-3px_0.5px_-3px_rgba(0,0,0,0.25),inset_1px_1px_1px_-0.5px_rgba(255,255,255,0.6),inset_-1px_-1px_1px_-0.5px_rgba(0,0,0,0.2),inset_0_0_6px_6px_rgba(255,255,255,0.1),0_0_12px_rgba(245,130,50,0.2)] 
        transition-all" />
        <div
...
> = {
  default: {
    outer: "bg-gradient-to-b from-[#F58232] to-[#D66A1E]",
    inner: "bg-gradient-to-b from-[#FF9E53] via-[#F58232] to-[#D66A1E]",
    button: "bg-gradient-to-b from-[#F58232] to-[#D66A1E]",
  ...
  gold: {
    outer: "bg-gradient-to-b from-[#F58232] to-[#EAD98F]",
    inner: "bg-gradient-to-b from-[#FFFDDD] via-[#F58232] to-[#FFF1B3]",
    button: "bg-gradient-to-b from-[#FFEBA1] to-[#D66A1E]",
    ...
    wrapperStyle: {
      ...
      boxShadow: isPressed
        ...
        : isHovered && !isTouchDevice
          ? "0 4px 12px rgba(245, 130, 50, 0.3)"
