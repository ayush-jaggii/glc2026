...
export default function DelegateAdvantage() {
  return (
    <section id="advantage" className="relative py-24 sm:py-32 bg-wine-950 overflow-hidden border-t border-wine-900/60">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-3xl mb-16 sm:mb-20">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-sm text-xs font-semibold tracking-widest uppercase bg-wine-900 text-glc-orange border border-wine-700 mb-4">
            ...
            <span>Executive Return on Engagement</span>
          </div>
          ...
          <p className="text-sm sm:text-base text-cream-200/90 leading-relaxed">
            GLC 2026 is engineered for senior leaders, strategy directors, GCC architects, and research scholars who require high-conviction insights rather than superficial conference platitudes.
          </p>
        </div>

        {/* Connected Flowing Numbered Path */}
              ...
              >
                ...
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <span className="font-mono text-4xl font-bold text-[#ffc5b6]">
                      {item.step}
                    </span>
                    <span className="text-[10px] font-mono font-semibold tracking-wider text-glc-orange uppercase px-2 py-1 rounded-sm bg-wine-900 border border-wine-700">
                      {item.metric}
                    </span>
                  </div>
                ...
                <div className="mt-8 pt-4 border-t border-wine-800/60 flex items-center justify-between text-[11px] font-mono text-cream-400">
